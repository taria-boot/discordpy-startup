...
食いつきそうな共通の話題とか出してあげたらいかがでしょう…"]
    ...
    if message.content.startswith("3密"):
        await message.channel.send(file=discord.File('C:/Users/Windows/Desktop/pyy/video0.mov'))
...
client.run('NjkwODUwODgzNjA4NzcyNjI4.XnXbBg.fOKhkbzzI3wiVuR_AJJiCzwJmrQ')